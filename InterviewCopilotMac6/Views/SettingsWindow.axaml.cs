...
namespace InterviewCopilotMac6.Views
{
    public partial class SettingsWindow : Window
    {
        ...
        private void SaveBtn_Click(object? sender, RoutedEventArgs e)
        {
            ...
            // Start from a clone of the existing config so fields not edited in this window
            // (Google/Firebase credentials, remembered account, etc.) are preserved without
            ...
            cfg.OverlayOpacity = Math.Round(OverlayOpacitySlider.Value / 100.0, 2);
        ...
        /// <summary>
        /// Deep-copies an AppConfig via JSON round-trip so callers can mutate fields
        /// without touching the shared _cachedConfig instance returned by LoadConfig().
        /// </summary>
